...
$(document).ready(()=>{$(".responses__slider").slick({infinite:!0,slidesToShow:3,slidesToScroll:1,prevArrow:'<img class="arrow left" src="img/left-arrow.svg"></img>',nextArrow:'<img class="arrow right" src="img/right-arrow.svg"></img>',responsive:[{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:576,settings:{slidesToShow:1,slidesToScroll:1}}]}),AOS.init({offset:300,duration:700,once:!0});const e=$(".sendOrder").offset().top;let o;$(".orderBtn").click(()=>{$("html, body").animate({scrollTop:e},"slow")}),$(".nav").click(e=>{const s=$(e.target).attr("data-section");void 0!==s&&(o=e.target,$("html, body").animate({scrollTop:$(s).offset().top},"slow"))});const s=[$(".mainPerfume").offset().top,$(".flavor").offset().top-50,$(".content").offset().top,$(".responses").offset().top,$(".sendOrder").offset().top-50];$(window).scroll(e=>{s.forEach((e,o)=>{pageYOffset>e&&pageYOffset<s[1+o]&&($(".nav__item").each(function(){$(this).removeClass("nav__boldItem")}),$($(".nav__item")[o]).addClass("nav__boldItem")),pageYOffset>s[s.length-1]&&($(".nav__item").each(function(){$(this).removeClass("nav__boldItem")}),console.log(o,s.length-1),$($(".nav__item")[s.length-1]).addClass("nav__boldItem"))}),pageYOffset>=$(".mainPerfume").offset().top?$(".nav").addClass("fixed"):$("nav").removeClass("fixed")})});